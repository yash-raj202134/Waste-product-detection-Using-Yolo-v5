...
from WasteProductDetection.entity.config_entity import ModelTrainerConfig
from WasteProductDetection.entity.artifacts_entity import ModelTrainerArtifact
