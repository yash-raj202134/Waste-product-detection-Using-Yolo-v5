...
from WasteProductDetection.entity.config_entity import DataValidationConfig
from WasteProductDetection.entity.artifacts_entity import DataValidationArtifact , DataIngestionArtifact
